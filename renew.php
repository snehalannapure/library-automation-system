...
<div class="col-md-7">
 ...
 <ul class="nav nav-pills">
        ...
        <li class="active"><a href="/renew.php">Renew my materials</a></li><br><br>
      </ul>
...
Extend for:<div style="text-align:left;font-size: 20px;"><br>
<input type="radio" checked>1 day<br>
<input type="radio">1 week<br>
<input type="radio">1 month<br>
</div>

<br>
<div style="text-align:left;font-size: 20px;"><br><a href="/logout.php"><button type="button" class="btn btn-default">Done</button></a>
</div>
<div class="col-md-1"></div>
